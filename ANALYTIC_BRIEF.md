...
|---|---|---|---|
| Point Break (1991) | point_break_KJB.txt (~143k) | point_break_BC.txt (~87k) | BC guest: Anita Sarkeesian (2018). KJB S4E22 (Sept 2025) |
| Casino Royale (2006) | casino_royale_KJB.txt (~127k) | casino_royale_BC.txt (~88k) | BC guest: Kenice Mobley |
| Austin Powers IMoM (1997) | austin_powers_KJB.txt (~110k) | austin_powers_BC.txt (~80k) | KJB is the S2E23 **live** show — flag the live-format confound. BC guest: Atsuko Okatsuka |
| Atomic Blonde (2017) | atomic_blonde_KJB.txt (~104k) | atomic_blonde_BC.txt (~105k) | KJB S2E22 (April 2023) — **earliest KJB in corpus**, the drift-test anchor. BC episode is the Vanessa Guerrero one |
| Die Hard (1988) | die_hard_KJB.txt (~91k) | die_hard_BC.txt (~97k) | KJB holiday special covers the original — confirm in-text before relying on it |
| The Fast and the Furious (2001) | fast_furious_KJB.txt (~113k) | bc_fast_furious.txt | KJB S4E30 (Jan 2026). BC episode is 2019 (Hobbs & Shaw promo window), guest Faye Orlove — **maximal era skew in the corpus** |
| Ocean's Eleven (2001) | kjb_oceans_eleven.txt | oceans_eleven_BC.txt (~55k) | KJB S4E3 (~late 2024, dated by Tyson v. Paul joke), guest Brian (Worst of All Possible Worlds) — **the KJB-with-guest control episode**. BC guest: Edgar Momplaisir; BC file is shorter than typical — check completeness before windowed comparison |
| The Rock (1996) | the_rock_KJB.txt (~69k) | the_rock_BC.txt (~87k) | KJB episode-22, early-numbering era |

### Tier 2 — preview-asymmetric pairs (5 films): BC full, KJB ~10-minute Patreon preview
| Film | KJB preview | BC file |
|---|---|---|
| The Birdcage | birdcage_KJB_preview.txt (~24k) | birdcage_BC.txt (~89k) |
| Romy and Michele's High School Reunion | romy_michele_KJB_preview.txt (~21k) | romy_michele_BC.txt (~87k) |
| Spice World | spice_world_KJB_preview.txt (~10k) | spice_world_BC.txt (~74k) |
| What Women Want | what_women_want_KJB_preview.txt (~11k) | what_women_want_BC.txt (~109k) |
| Sex and the City: The Movie | satc_KJB_preview.txt (~17k) | satc_BC.txt (~100k) |
...
**Essay template**: (1) pair specifics — dates, guests, lengths, live/preview caveats; (2) the strata walk, bottom-up, with one or two specimen moments quoted briefly; (3) hypothesis scorecard — which of H1–H14 this pair supports, complicates, or breaks; (4) what's genuinely new in this pair that no prior essay had. Target 2,500–4,000 words; density over length.
